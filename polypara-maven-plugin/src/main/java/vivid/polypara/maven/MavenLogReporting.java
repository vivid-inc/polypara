...
class MavenLogReporting {
    ...
    private static void report(
        ...
        log.accept(mojo.getI18nContext().getText(
                "vivid.polypara.report.field-value-constancy-violation",
    ...
    private static String fieldValue(
        ...
        if (fieldValue.isDefined()) {
            return mojo.getI18nContext().getText(
                    "vivid.polypara.report.field-value-constancy-violation-field-value",
                    versionDescription,
            ...
            return mojo.getI18nContext().getText(
                    "vivid.polypara.report.field-value-constancy-violation-field-absent",
                    versionDescription
            );
        }
    }
